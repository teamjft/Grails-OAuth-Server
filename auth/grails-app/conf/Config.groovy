...
environments {
    ...
    production {
        ...
        grails.serverURL = "http://107.170.28.146:8181"
    }
}
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.jft.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.jft.UserRole'
grails.plugin.springsecurity.authority.className = 'com.jft.Role'
